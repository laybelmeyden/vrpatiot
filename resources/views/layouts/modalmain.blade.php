                          ...
                          <div class="col s12 xl12">
                              ...
                              <div class="form_item" style="    margin-bottom: 25px !important;">
                                  ...
                                  <select class='browser-default' name="select_mon">
                                      <option value="Технологии виртуальной (VR) и дополненной реальности (AR) в создании военно-исторической реконструкции">Реконструкция с применением VR- и AR-технологий</option>
                                      <option value="3D моделирование, современная видеообработка и 2D анимации в создании военно-исторической реконструкции.">3D-моделирование и анимация</option>
                                      <option value="Компьютерные игры и обучающие программы.">Реконструкция в формате компьютерной игры</option>
                                  </select>
                              </div>
                              <div class="form_item">

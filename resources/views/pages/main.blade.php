...
<div class="header_title">
  <div class="container">
  <h1>Всер<span></span>ссийский <br> конкурс</h1>
  <h3>интерактивных реконструкций событий <br> Великой Отечественной войны</h3>
  <a class="waves-effect waves-light btn btn_header modal-trigger">Подать заявку</a>
  </div>
</div>
</section>
<!-- <div id="modal1" class="modal modal-fixed-footer"> -->
    ...
    <img src="assets/img/delete-button1.png"  class=" modal-close modal_form_close_all"alt="">
      ...
      <textarea class="input_main_form_modal" type="text" name="opis_proj" placeholder="" value="" maxlength="300" req style="height: 116px; padding-top: 20px !important;"></textarea>
      </div>
      <div class="form_item">
...
<div class="container">
  <div class="row info_containers">
      <p class="info_z" id="info_vol">Всероссийский конкурс интерактивных реконструкций событий Великой Отечественной войны</p>
...
Особенностью конкурса 2020 года является его тематическая направленность, посвященная 75-летию Победы в Великой Отечественной войне.</p>
      ...
      <p class="info_z_down_1">Основная цель Конкурса: Привлечение внимания молодежи и сохранение исторической памяти о событиях Великой Отечественной войны с использованием инновационных технических средств и цифровых технологий.</p>
  </div>
</div>
</section>
<section id="stages">
  <div class="container">
    <div class="row">
      ...
      <div class="col xl12" style="width: 100%;">
        ...
        <a href="https://vk.com/doc22052708_515231706?hash=bd620e6438b1933740&dl=4bb64a7b40d2583170" target="_blank" class="waves-effect waves-light btn btn_download"><img src="assets/img/download.svg" class="img_dowmload">СКАЧАТЬ ПОЛОЖЕНИЕ О КОНКУРСЕ</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col xl12 flex_cetnter">
        ...
        <a href="https://rusinnovations.com" >
          <img src="assets/img/logo_air.png" alt="" class="logo_part">
        </a>
        </div>
        <div class="col xl3 flex_cetnter ">
  ...
  <div class="container">
    <div class="row">
      <div class="col xl12">
        ...
        <a class="waves-effect waves-light btn btn_footer modal-trigger" href="/programm">Подать заявку</a>
        </div>
        <div class="col">
